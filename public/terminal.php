...
$quickCommands = [
    ...
    'install_scientific' => [
        ...
        'cmd' => 'python3 -m pip install scipy scikit-image --no-warn-script-location',
        'desc' => 'Memasang library saintifik tingkat tinggi untuk akurasi deteksi maksimal dan anti halusinasi'
    ],
    'run_migrate' => [
